...
# Ex: otaa_create_new_capacitive.sh 1 26011DAA NwkSkey AppSkey

echo "--> calling otaa_create_full_capacitive_device_with_dev_addr.sh $1 $2 $3 $4"
./otaa_create_full_capacitive_device_with_dev_addr.sh $1 $2 $3 $4
