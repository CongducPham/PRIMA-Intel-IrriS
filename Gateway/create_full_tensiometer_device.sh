...
# this script creates a watermark sensor as primary device, i.e. SOIL-AREA-1 and devAddr=26011DAA
...
echo "--> Add value 0"
curl -X POST "http://localhost/devices/62286d72f06c4c0001eba943/sensors/temperatureSensor_1/value" -H "accept: application/json" -H "Authorization: Bearer $TOK" -H  "Content-Type: application/json" -d "{\"value\":0}"
...
curl -X POST "http://localhost/devices/62286d72f06c4c0001eba943/sensors/temperatureSensor_1/meta" -H "accept: application/json" -H "Authorization: Bearer $TOK" -H  "Content-Type: application/json" -d "{\"value_index\":5}"