...
void si7021_Humidity::update_data()
{
  if (get_is_connected()) {
	  /*
		float humidity, temperature;
  	si7021_hum.getHumidity(humidity);
  	si7021_hum.getTemperature(temperature);
  	si7021_hum.triggerMeasurement();
...
double si7021_Humidity::get_value()
{  
