...
///////////////////////////////////////////////////////////////////
  ...
  // The default address for watermark soil sensor devices is 26011DB1
...
unsigned char DevAddr[4] = {0x26, 0x01, 0x1D, 0xB1};
  #else
  // The default device address, in Wazigate, mainly for SEN0308 capacitive soil sensor devices, is:
  // 26011DAA
